...
import io.github.skydynamic.quickbackupmulti.config.ScheduleConfig;
import io.github.skydynamic.quickbackupmulti.schedule.ScheduleManager;
import io.github.skydynamic.quickbackupmulti.schedule.runnables.DefaultDatabaseBackupRunnable;
import io.github.skydynamic.quickbackupmulti.schedule.runnables.DefaultPruneRunnable;
import io.github.skydynamic.quickbackupmulti.schedule.runnables.DefaultScheduleBackupRunnable;
...
public class OnLoadedWorldHandler {
    public static void handler() {
        ...
        QuickbackupmultiReforged.getModContainer().setAfterRestarting(false);
    }

    private static void registerSchedules() {
        ModConfig config = QuickbackupmultiReforged.getModConfig();
